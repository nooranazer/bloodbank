...
const View = () => {
  ...
  return (
    <div style={{ margin: "2%" }}>
      ...
      <center><Typography variant="h3"> Donor Dashboard</Typography></center><br/><br/>


   

        
         {/* <Button variant="contained" color="success"> <Link to={'/request'} style={{ textDecoration: 'none', color: 'white' }} > Request form  </Link>   </Button> &nbsp;
        <Button  variant="contained" color="success" > <Link to={'/donor'} style={{ textDecoration: 'none', color: 'White' }} > Donor form  </Link>   </Button>    */}
